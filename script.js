const quotes = [
  ...
  { text: "You’re never alone as long as you’re a Dragonfly.", source: "Against the Wind" },
  { text: "A promise to love, to live, to fight.", source: "Against the Wind" },
  { text: "We don’t have a choice. We’re Dragonflies. We don’t back down.", source: "Into the Night" },
  { text: "Together or not at all.", source: "Into the Night" },
  { text: "Dragonflies are the craziest girls you’ll ever meet.", source: "Into the Night" },
  { text: "I take care of mine.", source: "Against the Wind" },
  { text: "Because I’m going to kiss you and I don’t want to die.", source: "Against the Wind" },
  { text: "You want to turn my Dragonflies into assassins.", source: "Running on Empty" },
  { text: "You can’t make us kill people, Dodge.", source: "Running on Empty" },
  { text: "You are never to say that again, Greta Byrne.", source: "Running on Empty" },
  { text: "You’re already my family.", source: "Running on Empty" },
  { text: "You’re my alpha. My omega. You’re the beginning and the end.", source: "Running on Empty" },
